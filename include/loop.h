...
namespace mySLAM
{
    struct loopData
    {
        ...
        int index2;
        Eigen::Matrix4d T;
        loopData(int i1, int i2, Eigen::Matrix4d _T)
        {
            index1 = i1;
            index2 = i2;
            T = _T;
    ...
    public:
        ...
        void addTFSgroudtruth(std::vector<Eigen::Matrix4f> &tfs_ground);
    ...
    private:
        ...
        std::vector<Sophus::SE3d> tfs_groudtruth; //debug用的，因为我检测回环的技术很垃圾
    };
} // namespace mySLAM
